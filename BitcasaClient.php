...
class BitcasaClient
{
	...
	{ 
		...
		$bitcasa_access_token_NEW;
		 
		
				if (!empty($bitcasa_access_token_NEW)) {
					$this->access_token = $bitcasa_access_token_NEW;
					$this->client_id = '0e6dc619';
					$this->secret = '7113854a0c01e8067f390ba81b263327';
